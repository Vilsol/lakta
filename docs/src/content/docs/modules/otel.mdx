...
```go compile=stmt imports="os,github.com/Vilsol/lakta/pkg/lakta,github.com/Vilsol/lakta/pkg/config,github.com/Vilsol/lakta/pkg/logging/tint,github.com/Vilsol/lakta/pkg/logging/slog,github.com/Vilsol/lakta/pkg/otel"
lakta.NewRuntime(
    config.NewModule(
